...
1. 我们先在Service类库中添加对Domain和Common的项目引用，因为Service类似于数据服务管理层。
...
3. 下面是IRepository代码，**注意在分页查询中引用了Common类库中的[PageCollection.cs(点击查看)](https://gist.github.com/wghglory/7cb49c6529cc19c33a4b1e756f36edfd)**
